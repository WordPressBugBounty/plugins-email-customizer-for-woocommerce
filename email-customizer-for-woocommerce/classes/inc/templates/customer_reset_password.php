...
<td class="thwecmf-column-padding thwecmf-col thwecmf-columns" id="tpf_1002" data-name="one_column_one" style="vertical-align: top; box-sizing: border-box; border: 1px dotted #dddddd; word-break: break-word; padding: 10px 10px; padding-top: 45px; padding-right: 48px; padding-bottom: 45px; padding-left: 48px; width: 100%; border-top: 1px; border-right: 1px; border-bottom: 1px; border-left: 1px; border-style: dotted; border-color: #dddddd; background-color: #96588a; text-align: center; min-height: 0px;">
															<table class="thwecmf-block thwecmf-block-text" id="tpf_1003" data-block-name="text" cellspacing="0" cellpadding="0" style='table-layout: fixed; font-family: "Helvetica Neue",Helvetica,Roboto,Arial,sans-serif; line-height: 22px; margin: 0 auto; box-sizing: border-box; color: #ffffff; font-size: 30px; width: 100%; margin-top: 0px; margin-right: auto; margin-bottom: 0px; margin-left: auto; text-align: left;'><tbody style="color: #ffffff; font-size: 30px;"><tr style="color: #ffffff; font-size: 30px;">
<td class="thwecmf-block-text-holder" style='vertical-align: top; box-sizing: border-box; width: 100%; font-family: "Helvetica Neue",Helvetica,Roboto,Arial,sans-serif; line-height: 22px; padding: 15px 15px; color: #ffffff; font-size: 30px; text-align: left; background-color: transparent; border-top: 0px; border-right: 0px; border-bottom: 0px; border-left: 0px; border-color: transparent; border-style: none; padding-top: 0px; padding-right: 0px; padding-bottom: 0px; padding-left: 0px;'>
					<div class="wecmf-txt-wrap" style="color: #ffffff; font-size: 30px;">Welcome to <?php echo esc_html( get_bloginfo() );?><br style="color: #ffffff; font-size: 30px;">
</div>				</td>
			</tr></tbody></table>
</td>
																				</tr></tbody></table>
<table class="thwecmf-row thwecmf-block-one-column" id="tpf_1004" data-name="one_column" data-column-count="1" cellpadding="0" cellspacing="0" style="border-spacing: 0px; width: 100%; table-layout: fixed; max-width: 100%; margin: 0 auto; border: 0px solid transparent; padding-top: 0px; padding-right: 0px; padding-bottom: 0px; padding-left: 0px; margin-top: 0px; margin-right: auto; margin-bottom: 0px; margin-left: auto; border-top: 0px; border-right: 0px; border-bottom: 0px; border-left: 0px; border-style: none; border-color: transparent; background-color: transparent;"><tbody><tr>
<td class="thwecmf-column-padding thwecmf-col thwecmf-columns" id="tpf_1005" data-name="one_column_one" style="vertical-align: top; box-sizing: border-box; border: 1px dotted #dddddd; word-break: break-word; padding: 10px 10px; width: 100%; text-align: center; padding-top: 48px; padding-right: 48px; padding-bottom: 0px; padding-left: 48px; border-top: 0px; border-right: 0px; border-bottom: 0px; border-left: 0px; border-style: none; border-color: #dddddd; background-color: transparent; min-height: 0px;">
															<table class="thwecmf-block thwecmf-block-text" id="tpf_1006" data-block-name="text" cellspacing="0" cellpadding="0" style='table-layout: fixed; font-family: "Helvetica Neue",Helvetica,Roboto,Arial,sans-serif; line-height: 22px; margin: 0 auto; box-sizing: border-box; color: #636363; font-size: 14px; width: 100%; margin-top: 0px; margin-right: auto; margin-bottom: 0px; margin-left: auto; text-align: left;'><tbody style="color: #636363; font-size: 14px;"><tr style="color: #636363; font-size: 14px;">
...
<div class="wecmf-txt-wrap" style="color: #636363; font-size: 14px;">Someone has requested a new password for the following account on <?php echo esc_html( get_bloginfo() );?>:<br style="color: #636363; font-size: 14px;">
</div>
<div class="wecmf-txt-wrap" style="color: #636363; font-size: 14px;"><br style="color: #636363; font-size: 14px;"></div>
<div class="wecmf-txt-wrap" style="color: #636363; font-size: 14px;">Username: <?php if(isset($user_login)){ ?><?php echo '<strong>' . esc_html( $user_login ) . '</strong>' ?><?php } ?><br style="color: #636363; font-size: 14px;">
</div>
<div class="wecmf-txt-wrap" style="color: #636363; font-size: 14px;"><br style="color: #636363; font-size: 14px;"></div>
<div class="wecmf-txt-wrap" style="color: #636363; font-size: 14px;">If you didn't make this request, just ignore this email. If you'd like to proceed:<br style="color: #636363; font-size: 14px;">
</div>
<div class="wecmf-txt-wrap" style="color: #636363; font-size: 14px;"><br style="color: #636363; font-size: 14px;"></div>
...
<table class="thwecmf-row thwecmf-block-one-column" id="tpf_1007" data-name="one_column" data-column-count="1" cellpadding="0" cellspacing="0" style="border-spacing: 0px; width: 100%; table-layout: fixed; max-width: 100%; margin: 0 auto; border: 0px solid transparent; padding-top: 0px; padding-right: 0px; padding-bottom: 0px; padding-left: 0px; margin-top: 0px; margin-right: auto; margin-bottom: 0px; margin-left: auto; border-top: 0px; border-right: 0px; border-bottom: 0px; border-left: 0px; border-style: none; border-color: transparent; background-color: transparent;"><tbody><tr>
<td class="thwecmf-column-padding thwecmf-col thwecmf-columns" id="tpf_1008" data-name="one_column_one" style="vertical-align: top; box-sizing: border-box; border: 1px dotted #dddddd; word-break: break-word; padding: 10px 10px; width: 100%; text-align: center; padding-top: 0px; padding-right: 48px; padding-bottom: 48px; padding-left: 48px; border-top: 0px; border-right: 0px; border-bottom: 0px; border-left: 0px; border-style: none; border-color: #dddddd; background-color: transparent; min-height: 0px;">
															<table class="thwecmf-block thwecmf-block-text" id="tpf_1009" data-block-name="text" cellspacing="0" cellpadding="0" style='table-layout: fixed; font-family: "Helvetica Neue",Helvetica,Roboto,Arial,sans-serif; line-height: 22px; margin: 0 auto; box-sizing: border-box; color: #636363; font-size: 13px; width: 100%; margin-top: 0px; margin-right: auto; margin-bottom: 0px; margin-left: auto; text-align: center;'><tbody style="color: #636363; font-size: 13px;"><tr style="color: #636363; font-size: 13px;">
<td class="thwecmf-block-text-holder" style='vertical-align: top; box-sizing: border-box; width: 100%; font-family: "Helvetica Neue",Helvetica,Roboto,Arial,sans-serif; line-height: 22px; padding: 15px 15px; color: #636363; font-size: 13px; text-align: center; background-color: transparent; border-top: 0px; border-right: 0px; border-bottom: 0px; border-left: 0px; border-color: transparent; border-style: none; padding-top: 15px; padding-right: 0px; padding-bottom: 0px; padding-left: 0px;'><div class="wecmf-txt-wrap" style="color: #636363; font-size: 13px;"><?php echo esc_html( get_bloginfo() );?><br style="color: #636363; font-size: 13px;">
</div></td>
			</tr></tbody></table>
</td>
																				</tr></tbody></table>
