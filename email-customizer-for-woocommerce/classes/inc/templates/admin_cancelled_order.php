...
<div class="wecmf-txt-wrap" style="color: #636363; font-size: 14px;">Alas. Just to let you know — order #<?php if(isset($order)){ echo esc_html($order->get_id()); } ?> belonging to <?php 
if(isset($order)){
