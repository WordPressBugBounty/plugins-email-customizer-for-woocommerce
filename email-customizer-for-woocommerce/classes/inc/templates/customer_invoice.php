...
<div class="wecmf-txt-wrap" style="color: #636363; font-size: 14px;"><?php esc_html_e("Here are the details of your order placed on ",'email-customizer-for-woocommerce'); ?><?php if(isset($order)){ echo esc_html( wc_format_datetime($order->get_date_created()) ); } ?>:<br style="color: #636363; font-size: 14px;">
</div>
</td>
			</tr></tbody></table>
<?php if(isset($order)){ 
