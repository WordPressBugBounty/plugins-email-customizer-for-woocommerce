...
<div class="wecmf-txt-wrap" style="color: #636363; font-size: 14px;"><?php esc_html_e('Payment for order #','email-customizer-for-woocommerce');?><?php if(isset($order)){ echo esc_html($order->get_id()); } ?> <?php esc_html_e('from','email-customizer-for-woocommerce');?> <?php if(isset($order)){
