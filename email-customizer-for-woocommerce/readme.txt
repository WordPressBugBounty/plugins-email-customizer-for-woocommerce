...
* Added compatibility for the new **'Customer Failed Order'** email template.
...
= 2.6.1 =
* Fixed Sensitive Data Exposure vulnerability reported by Emili Castells from Patchstack.
